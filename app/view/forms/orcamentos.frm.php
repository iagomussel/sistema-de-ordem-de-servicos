<form class="form-horizontal" id="form_os">
                    <fieldset>
					<legend data-toggle="collapse" data-target="#dados_os">Dados Gerais</legend>
					<div id="dados_os" class="collapse in">
						...
						<div class="col-md-2">
                            ...
                            <div class="">
                                    ...
                                    <select id="tipo" name="tipo" class="form-control">
											<option value="0">Garantia</option>
											<option value="1">Fora de Garantia</option>
											<option value="2">Intalação</option>
											<option value="2">Visita Tecnica</option>
									</select>
						    </div>
                        </div>
                        <!-- Text input-->
						...
						<div class="col-md-3">
                        <label class="control-label" for="formpagto">Parcelamento</label>
                            <div class="">
                                <div class="input-group">
                                    ...
                                    <select id="formpagto"  name="formpagto" url="<?php echo Qr::inst("condpagtos")->table();?>" text="{{descricao}}" class="select2" required="" >				</select>
								</div>
                            </div>
                        </div>
						<div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-with-form">
											...
											<tr>
											  <td><input type="number" class="form-control input-sm" name="quantidade"  /></td>
											  <td><input type="text" class="form-control input-sm" name="servico"  /></td>
											  <td><input type="number" class="form-control input-sm" name="valorunit"  /></td>
